...
const DashboardPage = async (): Promise<JSX.Element> => {
  ...
  return (
    <main className="flex flex-col md:gap-8 md:h-full md:w-full">
      <section className='md:flex md:justify-between md:items-center pt-32'>
      ...
      <section className='flex md:flex-row w-full'>
        ...
        <section className='flex flex-col gap-8 md:gap-10 w-full'></section>
      </section>
    </main>
  )
}
